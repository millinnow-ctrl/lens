...
export const CAMERA_STYLES: CameraStyle[] = [
  ...
  },
  {
    ...
    character: {
      ...
      lens: { meterBias: 0.05, meterStrength: 0.9, faceWeight: 1, awb: 0, awbClamp: 0.3, toneMap: 0.15, shadowDenoise: 0.2, vibrance: 0, autoIso: 0.25, clarity: 0.35, dof: 0.2, skinGlow: 0.65, lightHalation: 0.3, flashStrength: 0.68, flashFalloff: 0.24, flashSpecular: 0.4, flashCool: 0.18, flashSpread: 1.7, keyVec: [0, 0], keyHardness: 0.12, fillCeiling: 0.9, shadowFill: 0.75 },
