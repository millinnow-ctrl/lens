...
struct CameraRecipe: Identifiable, Equatable {
  ...
  static let all: [CameraRecipe] = [
    ...
    .adaptive("iphone-flash", exposure: 0.18, adaptive: 0.60, warmth: -0.08, saturation: 1.08, contrast: 1.20, shadows: -0.08, highlights: 0.08, vignette: 0.05, bloom: 0.06, grain: 0.04, grainSize: 0.7, faces: true, warmCast: false, flash: 1.0, skin: 0.40, decisions: ["Face exposure prioritized", "Flash kept cool", "Background shadows held deep"]),
    .adaptive("camcorder-90s", exposure: 0.08, adaptive: 0.55, warmth: 0.02, saturation: 0.78, contrast: 0.92, shadows: 0.08, highlights: 0.24, vignette: 0.18, bloom: 0.10, grain: 0.20, grainSize: 1.5, faces: false, warmCast: true, gainNoise: true, smear: 0.85, smearDarkOnly: true, decisions: ["Auto gain followed the scene", "Color softened toward tape", "Shadow noise left visible"]),
    ...
    .adaptive("y2k-digicam", exposure: 0.20, adaptive: 0.70, warmth: -0.03, saturation: 1.22, contrast: 1.18, shadows: -0.02, highlights: 0.02, vignette: 0.04, bloom: 0.04, grain: 0.05, grainSize: 0.55, faces: true, warmCast: false, flash: 0.65, ccdClip: 1.0, smear: 0.6, decisions: ["Flash exposure favored", "Color pushed glossy", "Highlights allowed to clip"]),
    ...
    .adaptive("point-shoot", exposure: 0.14, adaptive: 0.72, warmth: -0.02, saturation: 1.14, contrast: 1.14, shadows: 0.02, highlights: 0.08, vignette: 0.08, bloom: 0.05, grain: 0.03, grainSize: 0.65, faces: true, warmCast: false, flash: 0.5, skin: 0.30, sky: 0.20, decisions: ["Face exposure favored", "Small-sensor clarity retained", "Flash color kept clean"]),
