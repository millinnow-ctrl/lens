...
struct CameraRecipe: Identifiable, Equatable {
  ...
  static let all: [CameraRecipe] = [
    ...
    .lut("film-noir", exposure: -0.10, warmth: 0, saturation: 0, contrast: 1.34, shadows: -0.10, highlights: 0.08, vignette: 0.22, bloom: 0.02, grain: 0.12, grainSize: 0.8, mono: true, postExposure: 0.0, referenceSpatial: ReferenceSpatialProfile(intensity: 0.88, acutance: 0.22, chromaticAberration: 0.0, distortion: 0.04, cornerSoftness: 0.45, shadowVignette: 0.68, grainLevel: 0.42, grainAmplitude: 1.05, grainChroma: 0.0, grainSize: 1.1), faces: true, warmCast: false, decisions: ["Color removed completely", "Face geometry separated", "Blacks allowed to fall"]),
    ...
    .lut("tintype", exposure: -0.08, warmth: 0.16, saturation: 0.52, contrast: 1.12, shadows: -0.06, highlights: 0.20, vignette: 0.48, bloom: 0.06, grain: 0.20, grainSize: 1.7, postExposure: 0.38, postMatrix: [0.948, 0, 0, 0, 1.015, 0, 0, 0, 1.059, 0, 0, 0], referenceSpatial: ReferenceSpatialProfile(intensity: 0.9, acutance: 0.22, chromaticAberration: 0.05, distortion: 0.02, cornerSoftness: 0.95, shadowVignette: 0.8, grainLevel: 0.35, grainAmplitude: 0.9, grainChroma: 0.0, grainSize: 1.3), faces: true, warmCast: true, decisions: ["Portrait tones translated to plate", "Edges allowed to fail", "Warm metal cast retained"]),
  ]
