// Extracted from lensmood-native/modules/vhs-export (Expo wrapper removed).
// Pure AVFoundation + Core Image — bakes the camcorder look (LUT from the
// reference vhsGrade + grain + flicker + vignette + counting REC timecode)
// into an .mp4. Compiled by SwiftUI CI; wired into UI in Phase D.
