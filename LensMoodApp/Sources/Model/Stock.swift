...
extension Stock {
  static let all: [Stock] = [
    Stock(id: "disposable", name: "Disposable", tagline: "Warm flash, soft grain", bestFor: "Friends after dark", exif: "F/11 · 400 · FLASH", g0: "#E5A94E", g1: "#C95B3E", symbol: "camera.fill", badge: "trending"),
    ...
    Stock(id: "a24-still", name: "Independent Still", tagline: "Muted color, soft highlights", bestFor: "Quiet narrative frames", exif: "F/2.8 · ISO 800 · 1/48", g0: "#42636A", g1: "#1D292C", symbol: "film.fill", badge: "featured"),
    ...
    Stock(id: "y2k-digicam", name: "Pocket 2002", tagline: "Glossy flash, bright color", bestFor: "Chaotic nights", exif: "F/2.6 · ISO 200 · FLASH", g0: "#5DB9D9", g1: "#9B52B4", symbol: "sparkles", badge: "trending"),
    ...
    Stock(id: "lomo", name: "Toy Color", tagline: "Punchy color, dark corners", bestFor: "Unpredictable daylight", exif: "F/2.8 · 400 · ZONE", g0: "#389866", g1: "#194A39", symbol: "camera.aperture", badge: "new"),
    ...
    Stock(id: "security-cam", name: "Monitor 02", tagline: "Grainy green, timestamped", bestFor: "Detached observation", exif: "CAM 02 · 12FPS · IR", g0: "#6CB98A", g1: "#294236", symbol: "eye.fill"),
    Stock(id: "point-shoot", name: "Pocket Compact", tagline: "Crisp flash, glossy color", bestFor: "Everyday immediacy", exif: "F/1.8 · 24MM · FLASH", g0: "#B6BBC2", g1: "#34373A", symbol: "camera.compact.fill", badge: "new"),
    ...
    Stock(id: "tokyo-neon", name: "Neon Night", tagline: "Neon bloom, wet streets", bestFor: "Colored city light", exif: "F/1.4 · ISO 1600", g0: "#2998A8", g1: "#AA59A5", symbol: "lightswitch.on.fill", badge: "trending"),
    Stock(id: "photobooth", name: "Photobooth", tagline: "Hard flash, true black and white", bestFor: "Close faces", exif: "STRIP · 4 FRAMES · B&W", g0: "#E8E7E2", g1: "#393936", symbol: "person.2.fill", badge: "new"),
