...
export const CAMERA_STYLES: CameraStyle[] = [
  ...
  },
  {
    ...
    tier: 'premium',
    badge: 'trending',
    defaults: P({ intensity: 88, grain: 35, contrast: 64, warmth: 46, flash: 42, shadows: 30, smoothing: 0 }),
    character: {
      ...
      bands: { sat: [0.06, 0.04, -0.28, -0.22, 0.08, 0.08], lum: [0.03, 0.04, -0.12, -0.06, -0.02, 0.02] },
      ...
      edgeFringe: { fringe: 0.7, block: 0.22 },
      curve: 0.35,
      hue: -4,
      saturate: 0.97,
      brightness: 0.92,
  ...
  },
  {
    ...
    tier: 'premium',
    badge: 'new',
    defaults: P({ intensity: 88, grain: 22, contrast: 68, warmth: 44, flash: 60, shadows: 60, smoothing: 0 }),
    character: {
      ...
      bands: { sat: [0.04, 0.04, -0.4, -0.35, 0.06, 0.06], lum: [0.02, 0, -0.16, -0.12, -0.06, -0.08] },
      lens: { meterBias: -0.4, meterStrength: 0.6, faceWeight: 0.95, awb: 0.5, awbClamp: 0.3, lightHalation: 0.2, toneMap: 0, dof: 0.08, autoIso: 0.35, clarity: 0.42, vibrance: 0.1, shadowDenoise: 0.4, skinGlow: 0.8, flashStrength: 0.72, flashFalloff: 0.7, flashSpecular: 0.6, flashCool: 0.5, flashSpread: 1.25, keyVec: [0, 0], keyHardness: 0.14, fillCeiling: 0.88, shadowFill: 0.72 },
      curve: 0.55,
      saturate: 0.92,
      brightness: 0.9,
      fade: 0,
