...
export const CAMERA_STYLES: CameraStyle[] = [
  ...
  },
  {
    ...
    character: {
      ...
      lens: { meterBias: 0.35, meterStrength: 0.7, awb: 0.3, lightHalation: 0.85, dof: 0.28, skinGlow: 0.7 },
      grainSize: 1.3,
  ...
  },
  {
    ...
    character: {
      ...
      lens: { meterStrength: 0.85, faceWeight: 0.8, awb: 0.8, awbClamp: 0.45, dof: 0.32, toneMap: 0.7, clarity: 0.15, vibrance: 0.6, shadowDenoise: 0.75, skinGlow: 0.95 },
      curve: 0.15,
      saturate: 1.03,
      brightness: 1.06,
      halation: 0.12,
  ...
  },
  {
    ...
    character: {
      ...
      lens: { meterStrength: 0.9, faceWeight: 0.85, awb: 0.85, dof: 0.85, toneMap: 0.4, clarity: 0.2, autoIso: 0.15, vibrance: 0.55, shadowDenoise: 0.5, skinGlow: 0.5 },
      grainSize: 0.6,
