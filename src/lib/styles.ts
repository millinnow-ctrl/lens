...
export const CAMERA_STYLES: CameraStyle[] = [
  ...
  },
  {
    ...
    character: {
      lens: { faceWeight: 0.7, dof: 0.55, toneMap: 0.6 },
      curve: 0.3,
      saturate: 0.94,
      brightness: 1.0,
      fade: 0.08,
  ...
  },
  {
    ...
    character: {
      lens: { meterStrength: 0.9, faceWeight: 0.85, awb: 0.85, dof: 0.85, toneMap: 0.4 },
      grainSize: 0.6,
  ...
  },
  {
    ...
    character: {
      ...
      halation: 0.12,
      fade: 0.05,
      tint: { color: '#0f6b7d', alpha: 0.12, blend: 'overlay' },
    },
    cardFilter: 'saturate(1.18) contrast(1.15) hue-rotate(-4deg)',
    gradient: 'linear-gradient(135deg,#ff9d5c,#0f6b7d)',
  },
  {
    id: 'pastel-cinema',
