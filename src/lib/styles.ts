...
export const CAMERA_STYLES: CameraStyle[] = [
  {
    ...
    character: {
      ...
      lens: { meterBias: 0.25, meterStrength: 0.85, faceWeight: 0.85, awb: 0.15, awbClamp: 0.2, lightHalation: 0.4, toneMap: 0.2, dof: 0.2, autoIso: 0.8, clarity: 0.15, vibrance: 0.5, shadowDenoise: 0.25, skinGlow: 0.9, flashStrength: 0.55, flashFalloff: 0.5, flashSpecular: 0.5, flashCool: 0.08, flashSpread: 1.4, keyVec: [0, 0], keyHardness: 0.12, fillCeiling: 0.9, shadowFill: 0.75 },
      grainSize: 1.25,
      grainAmp: 1.3,
      grainChroma: 0.55,
      colorMatrix: [1.06, 0.03, -0.09, 0.02, 1.03, -0.05, -0.03, 0.05, 0.99],
      curve: 0.45,
      leak: 0.08,
      sepia: 0.08,
      saturate: 1.12,
      ...
      fade: 0.04,
      halation: 0.3,
      splitTone: { shadows: '#46280f', highlights: '#ffd982', amount: 0.3 },
  ...
  },
  {
    ...
    character: {
      ...
      lens: { meterBias: 0, meterStrength: 0.85, faceWeight: 0.95, awb: 0.9, awbClamp: 0.4, lightHalation: 0.1, toneMap: 0.25, dof: 0.3, autoIso: 0.15, clarity: 0.4, vibrance: 0.6, shadowDenoise: 0.9, skinGlow: 0.85, flashStrength: 0.42, flashFalloff: 0.35, flashSpecular: 0.35, flashCool: 0.45, flashSpread: 1.5, keyVec: [0, 0], keyHardness: 0.15, fillCeiling: 0.83, shadowFill: 0.7 },
      curve: 0.4,
      saturate: 1.08,
      brightness: 1,
      fade: 0,
  ...
  },
  {
    ...
    character: {
      ...
      channelCurves: { r: [-0.06, 0.05], g: [0.0, 0.0], b: [0.08, -0.05] },
      dmax: 0.09,
      ...
      brightness: 0.99,
      halation: 0.2,
      splitTone: { shadows: '#1c453f', highlights: '#ece6d6', amount: 0.6 },
      grainSize: 1.05,
      grainAmp: 1,
      grainChroma: 0.25,
  ...
  },
  {
    ...
    tier: 'premium',
    badge: 'trending',
    defaults: P({ intensity: 86, grain: 32, contrast: 55, warmth: 46, flash: 40, shadows: 24, smoothing: 0 }),
    character: {
      ...
      bands: { sat: [0.06, 0.04, -0.14, -0.1, 0.08, 0.08], lum: [0.03, 0.04, -0.05, -0.02, -0.02, 0.02] },
      lens: { meterBias: -0.2, meterStrength: 0.7, faceWeight: 0.75, awb: 0.35, awbClamp: 0.25, lightHalation: 0.3, toneMap: 0.05, dof: 0.05, autoIso: 0.85, clarity: 0.42, vibrance: 0.1, shadowDenoise: 0.15, skinGlow: 0.5, flashStrength: 0.78, flashFalloff: 0.55, flashSpecular: 0.72, flashCool: 0.3, flashSpread: 1.4, keyVec: [0, 0], keyHardness: 0.1, fillCeiling: 0.92, shadowFill: 0.8 },
      channelCurves: { r: [0.0, -0.12], g: [0.0, 0.04], b: [0.0, -0.09] },
      dmax: 0.06,
      edgeFringe: { fringe: 0.22, block: 0.08 },
      curve: 0.35,
      hue: -4,
      saturate: 0.97,
      brightness: 0.94,
  ...
  },
  {
    ...
    character: {
      ...
      lens: { meterBias: -0.15, meterStrength: 0.35, faceWeight: 0.5, awb: 0.15, awbClamp: 0.18, lightHalation: 0.55, toneMap: 0, dof: 0.3, autoIso: 0.65, clarity: 0.3, vibrance: 0.5, shadowDenoise: 0, skinGlow: 0.35, flashStrength: 0, flashFalloff: 0.32, flashSpecular: 0.3, flashCool: 0.1, flashSpread: 1.3, keyVec: [-0.3, -0.95], keyHardness: 0.35, fillCeiling: 0.82, shadowFill: 0.45 },
      ...
      fade: 0,
      halation: 0.15,
      splitTone: { shadows: '#0b4a3c', highlights: '#ff8ec6', amount: 0.2 },
  ...
  },
  {
    ...
    name: 'Point & Shoot',
    tagline: 'Clean digital, true color',
    description:
      'A clean digital compact — natural colour, open shadows, a crisp bite and just a kiss of flash. The way a good point-and-shoot actually sees.',
    tier: 'premium',
    badge: 'new',
    defaults: P({ intensity: 80, grain: 16, contrast: 52, warmth: 47, flash: 42, shadows: 22, smoothing: 0 }),
    character: {
      // Clean digital compact: natural exposure with open shadows, honest colour, crisp micro-contrast, cool-neutral whites and only a soft fill of flash — not a crushed, oversaturated style.
      optics: { ca: 0.16, cornerSoft: 0.14, distortion: 0.1, flareAniso: 0.28 },
      bands: { sat: [0.05, 0.05, -0.04, -0.03, 0.05, 0.04], lum: [0.02, 0.01, -0.01, 0, -0.03, -0.03] },
      lens: { meterBias: -0.1, meterStrength: 0.6, faceWeight: 0.95, awb: 0.55, awbClamp: 0.3, lightHalation: 0.15, toneMap: 0.15, dof: 0.08, autoIso: 0.35, clarity: 0.4, vibrance: 0.28, shadowDenoise: 0.35, skinGlow: 0.5, flashStrength: 0.45, flashFalloff: 0.38, flashSpecular: 0.45, flashCool: 0.32, flashSpread: 1.3, keyVec: [0, 0], keyHardness: 0.14, fillCeiling: 0.9, shadowFill: 0.78 },
      curve: 0.3,
      saturate: 1.02,
      brightness: 0.99,
      fade: 0,
      halation: 0.1,
      fringe: 0.08,
      splitTone: { shadows: '#141821', highlights: '#f4f7fb', amount: 0.2 },
      highlightGuard: 0.8,
      tint: { color: '#cfdcf0', alpha: 0.04, blend: 'overlay' },
      colorMatrix: [1.04, 0.02, -0.06, -0.01, 1, 0.01, -0.03, 0, 1.03],
      grainSize: 0.7,
      grainAmp: 0.8,
      grainChroma: 0.1,
    },
    cardFilter: 'contrast(1.08) saturate(1.04) brightness(1.01) hue-rotate(-2deg)',
  ...
  },
  {
    ...
    character: {
      ...
      splitTone: { shadows: '#453a48', highlights: '#ffe6d2', amount: 0.32 },
      saturate: 0.92,
      brightness: 1,
      halation: 0.34,
  ...
  },
  {
    ...
    character: {
      ...
      splitTone: { shadows: '#0c1430', highlights: '#ffd9c8', amount: 0.5 },
      fringe: 1.2,
      saturate: 1.16,
      hue: -6,
      brightness: 0.96,
  ...
  },
  {
    ...
    character: {
      ...
      splitTone: { shadows: '#141414', highlights: '#f0dcc0', amount: 0.3 },
      ...
      tint: { color: '#caa877', alpha: 0.08, blend: 'soft-light' },
